...
require (
	...
	github.com/jtarchie/sqlitezstd v0.0.0-20240518224104-7614eeb34d8d
...
replace github.com/datadog/czlib => github.com/DataDog/czlib v0.0.0-20160811164712-4bc9a24e37f2
